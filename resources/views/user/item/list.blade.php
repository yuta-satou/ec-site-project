        ...
        {{-- <div class="container"> --}}
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li><a href="{{ route('create') }}">Home</a></li>
                    <!-- <li><a href="#">page</a></li> -->
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 wow fadeInLeft animated" data-wow-delay="">
                <div class="product-item">
                    <a href="#"><img id="" src= 'uploads/images/1.jpg' class="img-responsive shop_modal" width="255" height="322" alt=""></a>
                    <div class="item_details">
                        <p><span id="product_name">商品名</span><i class="fa-regular fa-user"></i></p>
                        <p><span id="product_price"> ¥10000</span></p>
